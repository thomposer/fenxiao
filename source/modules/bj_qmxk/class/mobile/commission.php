...
if ($op == 'display') {
    ...
    $commissioningpe = pdo_fetchcolumn('SELECT sum((g.commission*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE  ((o.shareid = ' . $profile['id'] . " and g.status = 0)   ) {$commissioningpewhere}  and o.weid = " . $_W['weid'] . '  and o.status >= 3 and o.from_user != \'' . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commissioningpex2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE  ((o.shareid2 = ' . $profile['id'] . " and g.status2 = 0)   ) {$commissioningpewhere}  and o.weid = " . $_W['weid'] . "  and o.status >= 3  {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commissioningpex3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE  ((o.shareid3 = ' . $profile['id'] . " and g.status3 = 0)   ) {$commissioningpewhere}  and o.weid = " . $_W['weid'] . "  and o.status >= 3  {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission1 = pdo_fetchcolumn('SELECT sum((g.commission*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid = ' . $profile['id'] . ' and g.status = 0)   )  and o.weid = ' . $_W['weid'] . ' and (o.status =1 or o.status =2) and o.from_user != \'' . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission1x2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ( (o.shareid2 = ' . $profile['id'] . ' and g.status2 = 0)  )  and o.weid = ' . $_W['weid'] . " and (o.status =1 or o.status =2) {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission1x3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ( (o.shareid3 = ' . $profile['id'] . ' and g.status3 = 0)  )  and o.weid = ' . $_W['weid'] . " and (o.status =1 or o.status =2) {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission2 = pdo_fetchcolumn('SELECT sum((g.commission*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid = ' . $profile['id'] . ' and g.status = 1)  )   and o.weid = ' . $_W['weid'] . '  and o.status >=3 and o.from_user != \'' . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission2x2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid2 = ' . $profile['id'] . ' and g.status2 = 1) )   and o.weid = ' . $_W['weid'] . "  and o.status >=3  {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission2x3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ( (o.shareid3 = ' . $profile['id'] . ' and g.status3 = 1)  )   and o.weid = ' . $_W['weid'] . "  and o.status >=3  {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission3 = pdo_fetchcolumn('SELECT sum((g.commission*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid = ' . $profile['id'] . ' and (g.status <0 or o.status <0)) ) and o.weid = ' . $_W['weid'] . '  and o.from_user != \'' . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission3x2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid2 = ' . $profile['id'] . ' and (g.status2 <0 or o.status <0)) ) and o.weid = ' . $_W['weid'] . "   {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission3x3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid3 = ' . $profile['id'] . ' and (g.status3  <0 or o.status <0)) ) and o.weid = ' . $_W['weid'] . "   {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission4x2 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid2 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =0 or o.status =1)) or ((o.paytype=1 or o.paytype=2 ) and o.status =0)) {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission4x3 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid3 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =0 or o.status =1)) or ((o.paytype=1 or o.paytype=2 ) and o.status =0)) {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission4_1x2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid2 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =0 or o.status =1)) or ((o.paytype=1 or o.paytype=2 ) and o.status =0)) {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission4_1x3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid3 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =0 or o.status =1)) or ((o.paytype=1 or o.paytype=2 ) and o.status =0)) {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission5x2 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid2 = ' . $profile['id'] . ')  and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status >1)) or ((o.paytype=1 or o.paytype=2 ) and o.status >0)) {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission5x3 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid3 = ' . $profile['id'] . ')  and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status >1)) or ((o.paytype=1 or o.paytype=2 ) and o.status >0)) {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission6x2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid2 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =1 or o.status =0)) or ((o.paytype=1 or o.paytype=2 ) and o.status =1)) {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission6x3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid3 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =1 or o.status =0)) or ((o.paytype=1 or o.paytype=2 ) and o.status =1)) {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission7x2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid2 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and o.status =3 {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission7x3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid3 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and o.status =3 {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission8x2 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid2 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =1 or o.status =0)) or ((o.paytype=1 or o.paytype=2 ) and o.status =1)) {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission8x3 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid3 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and ( (o.paytype=3 and (o.status =1 or o.status =0)) or ((o.paytype=1 or o.paytype=2 ) and o.status =1)) {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission9x2 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid2 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and o.status =3 {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission9x3 = pdo_fetchcolumn('SELECT sum((o.price)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE (o.shareid3 = ' . $profile['id'] . ') and o.weid = ' . $_W['weid'] . " and o.status =3 {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    ...
    $commission9_1x2 = pdo_fetchcolumn('SELECT sum((g.commission2*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid2 = ' . $profile['id'] . '  and g.status2=1)) and o.weid = ' . $_W['weid'] . " and o.status =3 {$level2enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
    $commission9_1x3 = pdo_fetchcolumn('SELECT sum((g.commission3*g.total)) FROM ' . tablename('bj_qmxk_order') . ' as o left join ' . tablename('bj_qmxk_order_goods') . ' as g on o.id = g.orderid and o.weid = g.weid WHERE ((o.shareid3 = ' . $profile['id'] . '  and g.status3=1)) and o.weid = ' . $_W['weid'] . " and o.status =3 {$level3enable} and o.from_user != '" . $from_user . '\' and  g.createtime>=' . $profile['flagtime']);
...
if ($op == 'commapply') {
    ...
    $conditionMember = 'select m.realname from ' . tablename('bj_qmxk_member') . ' m where m.from_user=orders.from_user and m.weid=' . $_W['weid'];
    $list2 = pdo_fetchall("SELECT 1 as level,orders.status,orders.createtime,orders.ordersn,bjog.status as status1,bjog.commission*bjog.total as commission,( {$conditionMember}) realname FROM " . tablename('bj_qmxk_order') . ' orders left join  ' . tablename('bj_qmxk_order_goods') . ' bjog on bjog.orderid=orders.id  WHERE  ((orders.shareid = ' . $profile['id'] . " and bjog.status = 0) )  {$commissioningpelist2where} and orders.weid = '{$_W['weid']}' and  orders.status >= 3 and orders.from_user != '" . $from_user . '\' and  bjog.createtime>=' . $profile['flagtime'] . ' union all (' . "SELECT 2 as level,orders.status,orders.createtime,orders.ordersn,bjog.status2 as status1,bjog.commission2*bjog.total as commission,( {$conditionMember}) realname FROM " . tablename('bj_qmxk_order') . ' orders left join  ' . tablename('bj_qmxk_order_goods') . ' bjog on bjog.orderid=orders.id  WHERE  ((orders.shareid2 = ' . $profile['id'] . " and bjog.status2 = 0) )  {$commissioningpelist2where} and orders.weid = '{$_W['weid']}' and  orders.status >= 3 and orders.from_user != '" . $from_user . '\' and  bjog.createtime>=' . $profile['flagtime'] . ') union all (' . "SELECT 3 as level,orders.status,orders.createtime,orders.ordersn,bjog.status3 as status1,bjog.commission3*bjog.total as commission,( {$conditionMember}) realname FROM " . tablename('bj_qmxk_order') . ' orders left join  ' . tablename('bj_qmxk_order_goods') . ' bjog on bjog.orderid=orders.id  WHERE  ((orders.shareid3 = ' . $profile['id'] . " and bjog.status3 = 0) )  {$commissioningpelist2where} and orders.weid = '{$_W['weid']}' and  orders.status >= 3 and orders.from_user != '" . $from_user . '\' and  bjog.createtime>=' . $profile['flagtime'] . ')');
