<?php defined('IN_IA') or exit('Access Denied');?>	<?php  if(empty($footer_off)) { ?><div id="footer"><?php  if($_W['account']['siteinfo']['footer']) { ?><?php  echo htmlspecialchars_decode($_W['account']['siteinfo']['footer'])?><?php  } else { ?>&copy;<?php  if(empty($_W['account']['name'])) { ?>维航团队<?php  } else { ?><?php  echo $_W['account']['name'];?><?php  } ?>&nbsp;&nbsp;<?php  } ?><?php  echo $_W['setting']['copyright']['statcode'];?></div><?php  } ?>
</div>
