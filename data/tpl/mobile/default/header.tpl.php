...
<head>
	...
	<meta name="keywords" content="<?php  if(empty($_W['setting']['copyright']['keywords'])) { ?>维航,微信,微信公众平台<?php  } else { ?><?php  echo $_W['setting']['copyright']['keywords'];?><?php  } ?><?php  if($_W['account']['siteinfo']['keywords']) { ?><?php  echo $_W['account']['siteinfo']['keywords'];?><?php  } ?>" />
	<meta name="description" content="<?php  if(empty($_W['setting']['copyright']['description'])) { ?>微信公众平台自助引擎，简称维航，维航是一款免费开源的微信公众平台管理系统。<?php  } else { ?><?php  echo $_W['setting']['copyright']['description'];?><?php  } ?><?php  if($_W['account']['siteinfo']['description']) { ?><?php  echo $_W['account']['siteinfo']['description'];?><?php  } ?>" />
