...
<div class="page-bizinfo">
	<div class="header">
		...
		<span id="post-date"><a href="weixin://contacts/profile/<?php  echo $_W['account']['account'];?>" class="contacts"><?php  if(empty($_W['account']['name'])) { ?>维航团队<?php  } else { ?><?php  echo $_W['account']['name'];?><?php  } ?></a></span>
	</div>
</div>
