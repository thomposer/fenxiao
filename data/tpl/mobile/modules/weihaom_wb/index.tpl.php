...
<html>
<head>
    <title><?php  echo $set['title1'];?></title>
    <meta charset="utf-8">
	<meta name="viewport" content="initial-scale=1, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0, width=device-width,target-densitydpi=device-dpi">
<script type="text/javascript" src="./source/modules/weihaom_wb/style/js/createjs.js"></script>    
<script type="text/javascript">
	...
	@media screen and (orientation:landscape) {#landscape {display: box; display: -webkit-box; display: -moz-box; display: -ms-flexbox;}}
    ...
    .welcome-bg {position:absolute;top:0;left:0;right:0;bottom:0; background: url(./source/modules/weihaom_wb/images/81345eabgw1ei0jyahwhwj20gp0qzt9s.jpg) center center no-repeat; background-size:100% 100%; opacity: .4;overflow: hidden;}
    ...
    .t1,.t2,.t3,.t4,.t5 { background-size:auto 100%;background-image:url(./resource/attachment/<?php  echo $set['fimg'];?>);}
    .tt1,.tt2,.tt3,.tt4,.tt5 { background-size:auto 86%;background-image:url(./resource/attachment/<?php  echo $set['bimg'];?>);}
...
<body onload="init()">
	...
	function gameInit(){
        createjs.Sound.registerSound( {src:"<?php  echo $_W['siteroot'];?>source/modules/weihaom_wb/style/ds.mp3", id:"err"} );
        createjs.Sound.registerSound( {src:"<?php  echo $_W['siteroot'];?>source/modules/weihaom_wb/style/ds.mp3", id:"end"} );
        createjs.Sound.registerSound( {src:"<?php  echo $_W['siteroot'];?>source/modules/weihaom_wb/style/ds.mp3", id:"tap"} );
		gameRestart();
	}
	...
	function showGameScoreLayer(){
		...
		l.style.display = 'block';
		window.shareData.tContent=shareTexts(bast);
	}
	...
	function shareText( score ){
		cookie('bast-score', score, 100);
		if( score <= 49 )
			return '呵呵！我得了'+score+'分！';
		if( score <= 99 )
			return '酷！我得了'+score+'分！';
		if( score <= 149 )
			return '帅呆了！我得了'+score+'分！<br/><br/>爱死你了，么么哒！';
		if( score <= 199 )
			return '太牛了！我得了'+score+'分！<br/><br/>你是我见过最棒的男人！';

		return '膜拜自己ing！得了'+score+'分！<br/><br/>你确定你是地球人？你是宇宙第一强人，再也没人能超越你了！';
	}
	function shareTexts( score ){
		cookie('bast-score', score, 100);
		if( score <= 49 )
			return '呵呵！我是 <?php  echo $realname;?>,得了'+score+'分！';
		if( score <= 99 )
			return '酷！我是 <?php  echo $realname;?>,得了'+score+'分！';
		if( score <= 149 )
			return '帅呆了！我是 <?php  echo $realname;?>,得了'+score+'分！';
		if( score <= 199 )
			return '太牛了！我是 <?php  echo $realname;?>,得了'+score+'分！我是不是我见过最棒的人?';

		return '我<?php  echo $realname;?>,膜拜自己ing！得了'+score+'分！我不确定我是地球人？再也没人能超越我了！';
	}
	function toStr(obj) {
	...
	$.getJSON("<?php  echo $this->createMobileUrl('index', array('id'=>$user['id'], 'rid'=>$rid))?>&r="+new Date().getTime(),function(res){
					cookie('bast-score', 0, 100);
				});
	...
	document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
	    ...
	    WeixinJSBridge.on('menu:share:appmessage', function(argv) {
	        WeixinJSBridge.invoke('sendAppMessage', {
				...
				var bast = cookie('bast-score');
				$.getJSON("<?php  echo $this->createMobileUrl('index', array('id'=>$user['id'], 'rid'=>$rid))?>&r="+new Date().getTime()+"&score="+bast,function(res){
					cookie('bast-score', res['message'], 100);
				});
	...
	<div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
		<div style="padding:0 5%;">
			...
			<div id="GameScoreLayer-share" class="BOX">
				<a style="text-decoration:none; color: white;" id="mebtn1" class="btn BOX-S" href="<?php  echo $this->createMobileUrl('phb', array('rid'=>$rid))?>">&nbsp;排行榜</a>
			</div>
	...
	<div id="welcome" class="SHADE BOX-M">
		...
		<div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
			<div style="margin:0 8% 0 9%;">
				<div style="font-size:2.6em; color:#FEF002;"><?php  echo $set['title1'];?></div><br/>
				<div style="font-size:2.2em; color:#fff; line-height:1.5em;"><?php  echo $set['description1'];?></div><br/><br/>
