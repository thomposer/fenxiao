            ...
            <?php  } else { ?>
                ...
                <div class="option-cont">
                    ...
                    <div class="option" val="<?php  echo $row['id'];?>" onclick="divClick(this)" sel ="false">
                        ...
                        <div><image src="<?php  echo img_url($row['thumb'])?>" style="width:95%;margin:10px;" /></div>
                        <?php  } ?>
                    ...
                    <img class="sep" src="./source/modules/vote/style/images/option_sep.jpg">
                    <?php  } } ?>
                </div>

                <div class="vote-cont">
                    <div style="height: 10px;"></div>
                    <img class="vote-btn" src="./source/modules/vote/style/images/vote.png" onclick="submit()"/>
                    <div style="height: 10px;"></div>
                </div>
            <?php  } ?>
