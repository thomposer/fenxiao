		...
		<table class="tb">
			...
			<tr>
				...
				<td>
					...
					<span class="help-block">模块标识符, 应对应模块文件夹的名称, 维航系统按照此标识符查找模块定义, 只能由字母数字下划线组成 </span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<span class="help-block">模块的发布页, 用于发布模块更新信息的页面, 推荐使用维航模块版块</span>
				</td>
			</tr>
			<tr>
		...
		<table class="tb">
			<tr>
				...
				<td>
					...
					<?php  } } ?>
					<span class="help-block">订阅特定的消息类型后, 此消息类型的消息到达维航系统后将会以通知的方式(消息数据只读, 并不能返回处理结果)调用模块的接受器, 用这样的方式可以实现全局的数据统计分析等功能. 请参阅 <a href="http://www.we7.cc/docs/#flow-module-subscribe">模块消息订阅</a></span>
					<div class="alert-warning alert" style="width:auto;margin-top:5px;">注意: 订阅的消息信息是只读的, 只能用作分析统计, 不能更改, 也不能改变维航处理主流程</div>
				</td>
			</tr>
			<tr>
		...
		<table class="tb">
			<tr>
				...
				<td>
					...
					<?php  } } ?>
					<span class="help-block">当前模块兼容的维航系统版本, 安装时会判断版本信息, 不兼容的版本将无法安装</span>
				</td>
			</tr>
			<tr>
