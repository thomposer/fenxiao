					...
					<table class="tb table table-bordered">
						<tr class="control-group">
							<td class="rule-content">
								<h4>
									<span class="pull-right"><a onclick="return confirm('取消设置的系统回复，确认吗？');return false;" href="<?php  echo create_url('rule/system/cancel', array('type' => 'welcome'))?>">取消</a><a href="<?php  echo $url_w;?>">编辑</a></span>
									<?php  echo $wechat['welcome']['rule']['name'];?> <small>（<?php  echo $note_w;?>）</small>
								</h4>
							</td>
						</tr>
						<tr class="control-group">
				...
				<td>
					...
					<table class="tb table table-bordered">
						<tr class="control-group">
							<td class="rule-content">
								<h4>
									<span class="pull-right"><a onclick="return confirm('取消设置的系统回复，确认吗？');return false;" href="<?php  echo create_url('rule/system/cancel', array('type' => 'default'))?>">取消</a><a href="<?php  echo $url_d;?>">编辑</a></span>
									<?php  echo $wechat['default']['rule']['name'];?> <small>（<?php  echo $note_d;?>）</small>
								</h4>
							</td>
						</tr>
						<tr class="control-group">
