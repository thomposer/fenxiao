			...
			<table class="tb">
				<tr>
					...
					<td>
						...
						<div class="help-block">SMTP服务器为发送邮件的服务器，维航程序内置了QQ的邮件服务器的信息，可直接使用。如果有特殊需要请自定义SMTP服务器</div>	
					</td>
				</tr>
			</table>
			...
			<table class="tb">
				<tr>
					...
					<td>
						...
						<div class="help-block">升级“维航”系统时，需要先删除升级锁，确保升级正常进行。</div>
					</td>
				</tr>
				<tr>
					<th>删除安装锁</th>
					<td>
						...
						<div class="help-block">重新安装“维航”系统时，需要先删除安装锁。</div>
					</td>
				</tr>
			</table>
		</form>
