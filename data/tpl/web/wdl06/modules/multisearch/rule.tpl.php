			...
			<?php  if($item) { ?>
				<div class="alert alert-info reply-news-list reply-news-list-first" id="preview_0">
					<div class="reply-news-list-cover">
						<img alt="" src="<?php  echo $_W['attachurl'];?><?php  echo $item['cover'];?>">
					</div>
					<div class="reply-news-list-detail">
						<div class="title"><span class="pull-right"><a onclick="return confirm('此操作不可恢复，确定删除吗？');return false;" href="<?php  echo $this->createWebUrl('delete', array('id' => $row['id']))?>">删除</a></span><?php  echo $item['title'];?></div>
