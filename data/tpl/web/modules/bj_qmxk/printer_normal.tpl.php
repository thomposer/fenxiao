		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td  style="text-align: center;"><a href="<?php  echo $this->createWebUrl('printer', array('op' => 'set_normal','id'=>$item['id']));?>">设为默认模板</a>&nbsp;&nbsp;&nbsp;
								<a target="_blank" href="<?php  echo $this->createWebUrl('printer', array('op' => 'printview_normal', 'id' => $item['id']))?>">预览</a>&nbsp;&nbsp;&nbsp;
						<a href="<?php  echo $this->createWebUrl('printer', array('op' => 'edit_normal', 'id' => $item['id']))?>">编辑</a>&nbsp;&nbsp;&nbsp;
						<a onclick="return confirm('此操作不可恢复，确认删除？');" href="<?php  echo $this->createWebUrl('printer', array('op' => 'del_normal', 'id' => $item['id']))?>">删除</a></td>
				</tr>
				<?php  } } ?>
			</tbody>
		</table>
